            ...
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto pr-2">
                @for (project of filteredProjects; track project) {
                  <div class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:border-primary dark:hover:border-secondary transform hover:scale-103">
                    ...
                    <div class="p-4">
                      ...
                      <div class="flex gap-4">
                        @if (project.demoUrl) {
                          <a [href]="project.demoUrl" target="_blank" rel="noopener" class="text-blue-600 dark:text-blue-400 hover:underline text-sm flex items-center">
                        ...
                        @if (project.link) {
                          <a  [href]="project.link" target="_blank" rel="noopener" class="text-blue-600 dark:text-blue-400 hover:underline text-sm flex items-center">
