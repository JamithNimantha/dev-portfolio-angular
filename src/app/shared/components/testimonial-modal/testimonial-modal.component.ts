            ...
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div class="grid grid-cols-1 gap-6 max-h-[70vh] overflow-y-auto py-4 pr-2">
                @for (testimonial of testimonials; track testimonial) {
                  <div class="border border-gray-200 dark:border-gray-700   bg-gray-50 dark:bg-gray-700 rounded-lg overflow-hidden shadow-md p-6 transition-all duration-300 group  hover:border-primary dark:hover:border-secondary transform hover:scale-104 hover:shadow-soft-lg">
                    <div class="flex items-start mb-4">
                      <div class="h-12 w-12 rounded-full overflow-hidden mr-4 flex items-center justify-center bg-white dark:bg-gray-800">
                        @if (testimonial.image && testimonial.image.trim().length > 0) {
                          <img
